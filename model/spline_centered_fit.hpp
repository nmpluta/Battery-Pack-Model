...
namespace spline_centered_fit_model_namespace {
...
{" (found before start of program)",
 ...
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 12, column 4 to column 13)",
 ...
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 2, column 4 to column 19)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 3, column 4 to column 19)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 4, column 4 to column 19)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 5, column 11 to column 12)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 5, column 14 to column 15)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 5, column 4 to column 19)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 6, column 11 to column 12)",
 " (in '/usr/battery-pack-model-and-data/model/spline_centered_fit.stan', line 6, column 4 to column 16)",
...
class spline_centered_fit_model final : public model_base_crtp<spline_centered_fit_model> {
 ...
 public:
  ~spline_centered_fit_model() { }
  
  inline std::string model_name() const final { return "spline_centered_fit_model"; }
  ...
  spline_centered_fit_model(stan::io::var_context& context__,
    ...
    static constexpr const char* function__ = "spline_centered_fit_model_namespace::spline_centered_fit_model";
  ...
  inline stan::scalar_type_t<VecR> log_prob_impl(VecR& params_r__,
    ...
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "spline_centered_fit_model_namespace::log_prob";
    (void) function__;  // suppress unused var warning
  ...
  inline void write_array_impl(RNG& base_rng__, VecR& params_r__,
    ...
    (void) DUMMY_VAR__;  // suppress unused var warning
    static constexpr const char* function__ = "spline_centered_fit_model_namespace::write_array";
    (void) function__;  // suppress unused var warning
  ...
  inline void transform_inits(const stan::io::var_context& context,
                              ...
                              std::vector<double>& vars,
                              std::ostream* pstream__ = nullptr) const {
     constexpr std::array<const char*, 4> names__{"beta_raw", "sigma", "mu0",
      "sigma0"};
...
using stan_model = spline_centered_fit_model_namespace::spline_centered_fit_model;
...
stan::math::profile_map& get_stan_profile_data() {
  return spline_centered_fit_model_namespace::profiles__;
}
